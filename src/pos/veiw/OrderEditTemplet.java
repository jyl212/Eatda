...
import dto.MenuDTO;
import pos.dao.OrderMenuEditDAOImple;
import pos.listener.OrderEditListenerTemplet;
import pos.service.OrderMenuEditService;
import pos.service.OrderMenuEditServiceImple;

public class OrderEditTemplet extends JPanel {
	public JCheckBox[] chkarr;
	public JLabel[] lblmenuarr;
	public JLabel[] lblpricearr;
	public JPanel[] panelarr;
	public OrderEdit mainView;
	public int sum;
	 ...
	 * Create the panel.
	 */
	public OrderEditTemplet(OrderEdit mainView, String menuType) {
		this.mainView = mainView;
		OrderMenuEditService service = new OrderMenuEditServiceImple();
		...
		for (int i = 0; i < panelarr.length; i++) {
			...
			menuDetail1.setLayout(new GridLayout(1, 1));
