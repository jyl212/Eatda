...
public class TableCardCalcDAOImple implements TableCardCalcDAO{
	...
	public int insert(String memId, int orderNo, int reserNo, int totalPrice) {
		...
		try {
			con = getConnect();
			ptmt = con.prepareStatement(PAYMENY_INFO2);
//			"insert into payment values(payment_SEQ.nextval,?,?,?,sysdate,?,'카드')";
