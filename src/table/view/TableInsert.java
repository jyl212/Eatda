...
import table.listener.TableInsertListener;

public class TableInsert extends JPanel {
	 ...
	 * Create the panel.
	 */
	public TableInsert(RestDTO restInfo) {
		...
		JLabel lblTitle = new JLabel("\uD14C\uC774\uBE14 \uB4F1\uB85D");
...
//		pTables.add(btnMISCSeat);
	...
	public TableInsert(MainFrame mainFrame,RestDTO restInfo) {
		this(restInfo);
		frame = mainFrame;
	}
	
	private void startEvent() {
		TableInsertListener listener = new TableInsertListener(this);
